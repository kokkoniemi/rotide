...
TS_GRAMMARS := \
	...
	embedded_template markdown markdown_inline toml yaml xml make diff latex bibtex hcl lua glsl kotlin svelte vue helm dockerfile clojure r gdscript zig swift perl scheme erlang elixir
...
CORE_SRCS = $(SRC_DIR)/rotide.c \
	...
	$(addprefix $(SRC_DIR)/input/, \
		...
		prompt.c text_pairs.c system_vim.c dispatch.c) \
