...
- EJS/ERB coverage includes generic injection highlighting: template tags, injected HTML, nested `<script>` JavaScript, nested `<style>` CSS, and template-code JavaScript/Ruby.
