...
static int editorTrySkipOverClosingPair(int c) {
	...
	(void)editorSetCursorFromPosition(E.cy, E.cx + 1);
	return 1;
}

static int editorTryAutoClosePair(int c) {
	char closing = '\0';
	...
	if (E.dirty != dirty_before) {
		(void)editorSetCursorFromOffset(start_offset + 1);
...
static int editorJumpToMatchingBracket(void) {
