...
#define EDITOR_TEXT_TREE_NODE_CAPACITY (EDITOR_TEXT_TREE_FANOUT + EDITOR_TEXT_TREE_NODE_SLACK)
...
void editorTextTreeCollectStats(const struct editorTextTree *tree, struct editorTextTreeStats *out);
