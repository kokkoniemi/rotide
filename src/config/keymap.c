...
static const struct keymapActionName g_keymap_action_names[] = {
        ...
        {"close_other_panes", EDITOR_ACTION_CLOSE_OTHER_PANES},
        {"focus_next_pane", EDITOR_ACTION_FOCUS_NEXT_PANE},
        {"focus_prev_pane", EDITOR_ACTION_FOCUS_PREV_PANE},
        ...
        {"git_unstage", EDITOR_ACTION_GIT_UNSTAGE},
        {"git_stage_all", EDITOR_ACTION_GIT_STAGE_ALL},
        {"git_discard", EDITOR_ACTION_GIT_DISCARD},
        {"git_commit", EDITOR_ACTION_GIT_COMMIT},
        {"git_commit_amend", EDITOR_ACTION_GIT_COMMIT_AMEND},
        {"git_refresh", EDITOR_ACTION_GIT_REFRESH},
        {"git_push", EDITOR_ACTION_GIT_PUSH},
        {"git_pull", EDITOR_ACTION_GIT_PULL},
        {"git_fetch", EDITOR_ACTION_GIT_FETCH},
        {"git_branches", EDITOR_ACTION_GIT_BRANCHES},
        {"git_log", EDITOR_ACTION_GIT_LOG},
        {"git_stashes", EDITOR_ACTION_GIT_STASHES},
        {"git_view_activate", EDITOR_ACTION_GIT_VIEW_ACTIVATE},
        {"git_branch_new", EDITOR_ACTION_GIT_BRANCH_NEW},
        {"git_branch_delete", EDITOR_ACTION_GIT_BRANCH_DELETE},
        {"git_cherry_pick", EDITOR_ACTION_GIT_CHERRY_PICK},
        {"git_revert", EDITOR_ACTION_GIT_REVERT},
        {"git_tag", EDITOR_ACTION_GIT_TAG},
