...
| Style / formatter / naming sweeps | `rotide-maintainer` | reformatted or table-touched files | no domain test needed | `make`, `make test`, `make format-check`, `make lint-prefixes` |
